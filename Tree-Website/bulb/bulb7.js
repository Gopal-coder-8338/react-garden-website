...
export function Bulb7TreeComponent(){

    return(
        <>
            <div className="plant1Details d-flex justify-content-between p-4 m-3">
                <div>
                    <img src="./bulb7.jpg" style={{cursor:'pointer'}} width='450' height='450' />
                </div>
                <div style={{marginRight:'20%'}}>
                    <h3>Serene Ixia (16 Bulbs Pack)</h3>
                    <Rating80 />
                    <div style={{display:'flex'}}>
                      <h5 className="mt-2 bg-danger text-center text-white p-2 m-1">Save 40%</h5>
                      <h3 style={{color:'grey'}} className="mt-2 text-center p-2 text-decoration-line-through">859</h3>
                      <h3 className="mt-2 text-center text-danger p-2">&#8377;516</h3>
                    </div>
                    <div>
