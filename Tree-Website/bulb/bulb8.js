...
export function Bulb8TreeComponent(){
    return(
        <>
            <div className="plant1Details d-flex justify-content-between p-4 m-3">
                <div>
                    <img src="./bulb8.jpg" style={{cursor:'pointer'}} width='450' height='450' />
                </div>
                <div>
                    <h2>Chincherinchee, Ornithogalum (Orange) - Bulbs</h2>
                    <Rating100 />
                    <div style={{display:'flex'}}>
                      <h5 className="mt-2 bg-danger text-center text-white p-2 m-1">Save 2%</h5>
                      <h3 style={{color:'grey'}} className="mt-2 text-center p-2 text-decoration-line-through">205</h3>
