...
export function Garden10TreeComponent(){

    return(
        <>
            <div className="garden1Detail">
                <div>
                    <img src="./garden10.jpg" style={{cursor:'pointer'}} width='450' height='450' />
                </div>
                <div className="p-5"> 
                    <h2>Best 4 Classic Air Plants Pack</h2>
                    <Rating80 />
                    <div style={{display:'flex'}}>
                      <h5 className="mt-2 bg-dark text-center text-white p-2 m-1">Sold out</h5>
                      <h3 style={{color:'grey'}} className="mt-2 text-center p-2 text-decoration-line-through">349</h3>
