...
export function Plant10TreeComponent() {

    return(
        <>
            <div className="plant1Details d-flex justify-content-between p-4 m-3">
                <div>
                    <img src="./plant10.jpg" style={{cursor:'pointer'}} width='450' height='450' />
                </div>
                <div style={{marginRight:'20%'}}>
                    <h2>Banana - G9, Kela - Plant</h2>
                    <Rating80 />
                    <div style={{display:'flex'}}>
                      ...
                      <h3 className="mt-2 text-center text-danger p-2">&#8377;350</h3>
                    </div>
                    <div>
