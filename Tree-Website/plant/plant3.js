...
export function Plant3TreeComponent() {
    ...
    return(
        ...
        <>
                ...
                <div>
                    <img src="./plant3.jpg" style={{cursor:'pointer'}} width='450' height='450' />
                </div>
                <div>
                    <h2>Money Plant, Scindapsus (Green) - Plant</h2>
                    <Rating80 />
                    <div style={{display:'flex'}}>
                      <h5 className="mt-2 bg-danger text-center text-white p-2 m-1">Save 10%</h5>
                      <h3 style={{color:'grey'}} className="mt-2 text-center p-2 text-decoration-line-through">179</h3>
                      <h3 className="mt-2 text-center text-danger p-2">&#8377;169</h3>
                    </div>
                    <div>
