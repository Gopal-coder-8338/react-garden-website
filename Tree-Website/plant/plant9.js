...
export function Plant9TreeComponent() {
    ...
    return(
        <>
            ...
            <div className="plant1Details d-flex justify-content-between p-4 m-3">
                <div>
                    <img src="./plant9.jpg" style={{cursor:'pointer'}} width='450' height='450' />
                </div>
                <div>
                    <h3>Rhoeo Plant, Rhoeo discolor (Tricolor, Variegated) - Plant</h3>
                    <Rating99 />
                    <div style={{display:'flex'}}>
                      ...
                      <h3 className="mt-2 text-center text-danger p-2">&#8377;207</h3>
                    </div>
                    <div>
