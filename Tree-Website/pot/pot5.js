...
export function Pot5TreeComponent(){

    return(
        <>
            <div className="plant1Details d-flex justify-content-between p-4 m-3">
                <div>
                    <img src="./pot5.jpg" style={{cursor:'pointer'}} width='450' height='450' />
                </div>
                <div>
                    <h3>3 inch (8 cm) Handi Shape Round Ceramic Pots - Pack of 5</h3>
                    <Rating100 />
                    <div style={{display:'flex'}}>
                      <h5 className="mt-2 bg-dark text-center text-white p-2 m-1">Sold out</h5>
                      <h3 style={{color:'grey'}} className="mt-2 text-center p-2 text-decoration-line-through">549</h3>
                      <h3 className="mt-2 text-center text-danger p-2">&#8377;509</h3>
                    </div>
                    <div>
