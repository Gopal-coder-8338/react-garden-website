...
export function Seed3TreeComponent() {

    return(
        <>
            <div className="plant1Details d-flex justify-content-between p-4 m-3">
                <div>
                    <img src="./seed3.jpg" style={{cursor:'pointer'}} width='450' height='450' />
                </div>
                <div>
                    <h3>Mesembryanthemum, Ice Plant Mixed Color - Flower Seeds</h3>
                    <Rating80 />
