...
export function Seed5TreeComponent() {

    return(
        <>
            <div className="plant1Details d-flex justify-content-between p-4 m-3">
                <div>
                    <img src="./seed5.jpg" style={{cursor:'pointer'}} width='450' height='450' />
                </div>
                <div style={{marginRight:'10%'}}>
                    <h3>Robinia Pseudoacacia, Black Locust - 0.5 kg Seeds</h3>
                    <Rating100 />
                    ...
                    <div>
                        ...
                        <ul>
                            <li>Shipping ₹35 for entire order</li>
